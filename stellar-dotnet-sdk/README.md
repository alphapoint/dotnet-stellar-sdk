...
|:------------------------------------|:-----------------------------------------|:--------------|
| `GET /assets`                       | Disabled by default.                     | 0.4.0         |
| `GET /accounts/{account_id}/offers` | `last_modified_time` field can be `null` | 0.4.0         |
| `GET /offers/{offer_id}/trades`     | Query fields and syntetic IDs            | 0.4.0         |
...
| `GET /accounts/{account_id}`        | Displaying `auth_immutable` flag         | 0.4.0         |
